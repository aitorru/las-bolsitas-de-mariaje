...
export default function ContactClient({ categories }: Props) {
  ...
  return (
    <div className="min-h-screen max-h-screen flex flex-col">
      ...
      <div
        className={`container flex flex-row gap-7 max-w-fit mx-auto my-auto justify-around ${
          animateQr ? "" : "translate-x-60"
      ...
      >
        <div className="flex flex-col gap-7 transition">
          ...
          <h2 className="text-3xl md:text-5xl text-center text-ellipsis">
        ...
        <Image
          ...
          className={`hidden lg:block ${
            animateQr ? "scale-100" : "scale-0 hidden"
          } transition ease-in-out duration-1000 relative object-scale-down w-1/4`}
          src={QR}
        />
      </div>
    </div>
...
const Phone = () => {
  return (
    <svg
      ...
      className="w-[1.5rem] h-[1.5rem] md:h-[2.5rem] md:w-[2.5rem] ml-2"
      viewBox="0 0 20 20"
      fill="currentColor"
    >
      <path
...
const Mail = () => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="md:h-[2.7rem] md:w-[2.7rem] ml-2 hidden md:block"
      viewBox="0 0 20 20"
      fill="currentColor"
    >
