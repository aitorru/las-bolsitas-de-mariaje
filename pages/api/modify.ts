...
export default async function handler(
  ...
  return await new Promise((resolve) => {
    ...
    form.parse(
      req,
      async function (err: string, fields: formidable.Fields, files: any) {
        ...
        if (typeof fields.name === "string" && fields.name !== undefined) {
          if (fields.name !== "") {
        ...
        if (fields.price !== undefined && typeof fields.price === "string") {
        ...
        if (
          ...
          typeof fields.descripcion === "string"
        ) {
