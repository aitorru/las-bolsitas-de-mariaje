...
const BackToTop: NextPage<{visible: boolean}> = ({ visible }) => {
    ...
    return (
        <button 
            className={`sticky h-min z-20 right-6 p-2 rounded-xl bg-blue-700  shadow-blue-700/50 text-white transition-all duration-700 hover:scale-110 ${visible ? 'shadow-xl' : 'scale-0'}`}
            onClick={() => {
